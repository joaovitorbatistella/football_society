...
export default {
  ...
  data: () => ({
    ...
    gameHour: '',
    gameDateModal: false,
    heading: 'Relatorio de Atendimentos',
    gameTime: null,
    gameTimeModal: false,
          ...
          .then(({ data }) => {
            ...
            this.editedItem[0] = {
              ...
              customer: {
                ...
                nome: data.response[0].nome_cliente
              }
            }
